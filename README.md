...
2. Создайте новый репозиторий на GitHub, который будет использоваться для хранения и совместной работы 
над вашим проектом.
...
4. В директории *src* вашего проекта создайте модуль *processing*, который будет содержать новые функции обработки 
данных. 
