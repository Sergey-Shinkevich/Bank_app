...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Visa Platinum", "Не правильное название карты / счета"),
        ("Visa Gold", "Не правильное название карты / счета"),
    ],
)
...
@pytest.mark.parametrize(
    "date, result",
    [
        ("2019-07-03T18:35:29.5123641", False),
        ("20A9-07-03T18:35:29.512364", False),
        ("2019107103T18:35:29.512364", False),
        ("2019-07-03T18635:29.512364", False),
        ("2019-07-03T18:35729.512364", False),
        ("2019-07-03T18:35:297512364", False),
    ],
)
